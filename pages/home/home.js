			...
			<div>
				<Div>
					...
					<Text>
						...
						which require credit cards and sensitive data inorder to make necessary payements relating to
						the service .
						<br /> During a succesful synchronization process between the EvoHub App and an Electric Vehicle
						, data is exposed between the two parties and this has the potential create alot of security
						risks if which not well handled could lead to a leak of credentials . <br /> We are aware of
						this dangers and preventive measures have been put in place to reduce these threat levels to a
						minimum.
					</Text>
					<Image
						unloader={<Spinner />}
					...
					<Text>
						...
						together lists of possible questions and their answers. Feel free to reach out to us if a
						question is not fully explained or well answered !{' '}
					</Text>
